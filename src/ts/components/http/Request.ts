...
import NodeRequest from '../compatibility/NodeRequest';
import ExpressRequest from '../compatibility/ExpressRequest';
import { inherit_prototype, array_buffer_to_string } from '../../shared/operators';
...
export default class Request {
     ...
     */
    constructor(route: Route, raw_request, raw_response) {
