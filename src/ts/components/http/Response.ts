import { STATUS_CODES as status_codes } from 'http';
...
import NodeResponse from '../compatibility/NodeResponse.js';
import ExpressResponse from '../compatibility/ExpressResponse.js';
import { inherit_prototype } from '../../shared/operators.js';

const FilePool = {};
import LiveFile from '../plugins/LiveFile.js';
import SSEventStream from '../plugins/SSEventStream.js';
...
export default class Response {
    ...
    #upgrade_socket = null;
    #raw_response: uWebSockets.HttpResponse | null = null;
     ...
     */
    constructor(route: Route | null, wrapped_request: uWebSockets.HttpRequest | null, raw_response: uWebSockets.HttpResponse | null, socket: uWebSockets.us_socket_context_t | null = null) {
        this.route = route;
     ...
     * @returns {Response}
     */
    send(body: string|Buffer|ArrayBuffer, close_connection?: boolean) {
