...
import { wrap_object, async_wait } from '../../shared/operators';
...
export default class LiveFile extends EventEmitter {
    ...
    constructor(options: {
        ...
        var tmp = this.#options.path.split('.');
        this.#extension = tmp[this.#extension.length - 1];
    ...
    #reload_promise: Promise<any> | null;
    #reload_resolve: ((value?: any) => void) | null;
    #reload_reject: ((reason?: any) => void) | null;
    ...
    #ready_promise: Promise<any> | true | undefined;
    #ready_resolve: ((value?: any) => void) | null;
