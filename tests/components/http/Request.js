...
async function test_request_object() {
    ...
    let body_test_value = random_string(10);
    ...
    assert_log(
        group,
        candidate + '.json()',
        () => JSON.stringify(body.body.json) === options.body
    );
